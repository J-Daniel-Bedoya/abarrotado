const contactoTemplate = (name, email, affair, message) => `
  <!DOCTYPE html>
                          ...
                          <table style="width:100%">
                            <tr>
                              <td
                                ...
                                <a href="#"
                                  style="text-decoration: none;color:#ffffff;font-weight: 600;font-size: 18px;">
                                  Bien hecho!
                                </a>
                              </td>
                              <td style="width:30%;">
...
module.exports = contactoTemplate;
